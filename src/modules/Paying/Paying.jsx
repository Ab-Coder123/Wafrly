...
const Payingdata2 = ({ PayingdataProp2 }) => {
    ...
    // الجزء ال خاص ب الايداع الاليكتروني و المصرفي 
    const [payment, setPayment] = useState('payment'); // 'one-way' or 'round-trip'
    const [showelectron, setShowelectron] = useState(true); // حالة للتحكم في إظهار مكون Optiondata
    const [optionDeposit, setShowDepositt] = useState(false); // حالة للتحكم في إظهار المكون الثاني
    ...
    const handleShowelectron = () => {
        setShowelectron(true);
        setShowDepositt(false); // 
    };

    const handleShowDepositt = () => {
        setShowDepositt(true);
        setShowelectron(false);
    };
    // 
                    ...
                    <>
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-10 ' key={payprop2.id}>
                            ...
                            <div className=" col-span-10 border border-solid border-gray-400  rounded-md shadow-md p-1.5 flex mb-4 mt-7 gap-3">
                                ...
                                >
                                    <select
                                        className="w-full bg-transparent border-none text-center"
                                        value={payment}
                                        onChange={(e) => {
                                    ...
                                    >
                                        <option
                                            className={`text-gray-400 ${payment === "payment" ? "font-bold" : ""}`}
                                            value="payment"
                                        >
                                            إيداع إلكتروني
                                        </option>
                                        <option
                                            className={`text-gray-400 ${payment === "Deposits" ? "font-bold" : ""}`}
                                            value="Deposits"
                                        >
                                            إيداع مصرفي
                                        </option>
                            ...
                            <div className=' col-span-10 flex flex-col '>
                                ...
                                {optionDeposits &&
                                    <div>
                                        ...
                                        <div>
                                            {showelectron &&
                                                < OptionDepositspayment />
                                            }
                                        </div>

                                        <div>
                                            {optionDeposit &&
                                                <OptionDeposits OptdatapropDeposit={OptionDeposit} />
                                            }
                                        </div>
            ...
            <div className='py-5'>
                ...
                {show && (
                    <div className="my-5 p-1  flex flex-col ">
                        ...
                        {show && (
                            <div>
                                <form className='flex flex-col md:flex-row items-start gap-4 mt-3 ' action="">
                                    <div>
                                        <label htmlFor=""></label>
        ...
        <div className="my-5 p-1 flex flex-col">
            ...
            {show && (
                <div className="my-5 p-1 flex flex-col">
                    ...
                    {bank && (
                        <div>
                            <form className='flex flex-col md:flex-row items-start gap-4 mt-3'>
                                <input type="number" className='bg-gray-200 shadow-md border p-2 2 rounded-md' placeholder='0' />
...
const OptionDepositspayment = () => {
    return (
        <>
            <div className="modal py-10 my-5">
                <form className="form">
